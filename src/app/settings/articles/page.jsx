          ...
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 12 }}>
              <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                <input
                  ...
                  style={{ width: "min(460px, 100%)", background: "#0f1923", color: "#fff", border: "1px solid #2a4a5e", borderRadius: 8, padding: "8px 10px" }}
                />
                <button
                  type="button"
                  onClick={toggleSelectAllVisible}
                  style={{ background: "#1a2e3b", color: "#fff", border: "1px solid #2a4a5e", borderRadius: 8, padding: "8px 10px", cursor: "pointer", fontSize: 12 }}
                >
                  Markera alla synliga
                </button>
              </div>
              <div style={{ color: "#6b8fa3", fontSize: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 12 }}>
              <input
                ...
                style={{ width: "min(320px, 100%)", background: "#0f1923", color: "#fff", border: "1px solid #2a4a5e", borderRadius: 8, padding: "8px 10px" }}
              />
              <button
                type="button"
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 900 }}>
              <thead>
                <tr style={{ borderBottom: "1px solid #2a4a5e" }}>
                  <th style={{ color: "#6b8fa3", textAlign: "left", padding: "8px 10px", fontSize: 12, textTransform: "uppercase", width: 34 }}>✓</th>
                  <th style={{ color: "#6b8fa3", textAlign: "left", padding: "8px 10px", fontSize: 12, textTransform: "uppercase" }}>Artikelnr</th>
                  <th style={{ color: "#6b8fa3", textAlign: "left", padding: "8px 10px", fontSize: 12, textTransform: "uppercase" }}>Artikelnamn</th>
                  <th style={{ color: "#6b8fa3", textAlign: "left", padding: "8px 10px", fontSize: 12, textTransform: "uppercase" }}>Rapportgrupp</th>
                </tr>
              </thead>
              <tbody>
                {filteredRows.map(row => (
                  <tr key={row.article_number} style={{ borderBottom: "1px solid #1e3545" }}>
                    ...
                    <td style={{ padding: "10px" }}>
                      <input
                        ...
                        style={{ width: "100%", background: "#0f1923", color: "#fff", border: "1px solid #2a4a5e", borderRadius: 8, padding: "8px 10px" }}
                      />
                    </td>
                    <td style={{ padding: "10px" }}>
                      <input
